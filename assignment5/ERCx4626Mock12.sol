...
contract SolmateERC20 is ERC20 {
    constructor() ERC20("Solmate", "SLM", 18) {}

    // external `mintToken` function to provide initial asset to the vault
...
abstract contract ERC4626 is ERC20 {
    ...
    function maxMint(address) public view virtual returns (uint256) {
        return convertToShares(asset.balanceOf(msg.sender));
    }
...
contract ERCx4626Mock12 is ERC4626 {
    SolmateERC20 erc20 = new SolmateERC20();

    constructor() ERC4626(erc20, "Vault", "VT") {
        // give initial shares
        _mint(address(this), 101e18);
        // give initial assets to the underlying token
        erc20.mintToken(address(this), 100e18);
    }
